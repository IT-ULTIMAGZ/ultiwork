                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="itemForm" method="post" action="<?php echo base_url(); ?>levelpengguna/updatelevelpengguna">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input class="form-control" id="menu" name="menu" type="text" value="<?php echo $menu ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
