                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() ?>pekerjaan/ambil/<?php $idx=$row->IdPekerjaan; echo $idx = $this->encryption->encode($idx); ?>" class="label label-primary">Kerjakan</a>
                                                        <?php if(($row->PekerjaanDari==$row->IdPengguna) || ($row->PekerjaanDari==$this->session->userdata('penggunaid'))){ ?>
                                                        <a href="<?php echo base_url() ?>pekerjaan/edit_pekerjaan/<?php $id=$row->IdPekerjaan; echo $this->encryption->encode($id); ?>/Lihat_Pekerjaan" class="label label-success">Edit Pekerjaan</a>
                                                        <a href="<?php echo base_url() ?>pekerjaan/hapus_pekerjaan/<?php $id=$row->IdPekerjaan; echo $this->encryption->encode($id); ?>" class="label label-danger" onclick="return confirm('yakin ingin menghapus data pekerjaan ini');">Hapus</a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <table id="datatable-responsive-3" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php 
                                                $no=1;foreach ($dataRebutan->result() as $row) { ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td>
                                                        <?php 
                                                    ...
                                                    <td>
                                                        <?php if($this->session->userdata('as')=='Anggota'){ ?>
                                                        <a href="<?php echo base_url() ?>pekerjaan/ambil/<?php $idx=$row->IdPekerjaan; echo $idx = $this->encryption->encode($idx); ?>/<?php echo $this->encryption->encode($row->Status); ?>" class="label label-primary">
                                                            <?php if($row->Status==6){echo"Ambil Sekarang!!!";}else{echo"Kerjakan";} ?>
                                                        </a>
                                                        <?php } ?>
                                                        <?php  if($this->session->userdata('as') != 'Anggota' && $row->PekerjaanDari==$this->session->userdata('penggunaid')){ ?>
                                                        <a href="<?php echo base_url() ?>pekerjaan/edit_pekerjaan/<?php $id=$row->IdPekerjaan; echo $this->encryption->encode($id); ?>/Lihat_Pekerjaan" class="label label-success">Edit Pekerjaan</a>
