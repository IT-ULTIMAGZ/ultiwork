                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-border panel-primary">
                                    <div class="panel-heading"> 
                                        <h3 class="panel-title">Grafik Kecamatan</h3> 
                                    </div> 
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <table id="datatable-responsive" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php $no=1;foreach ($data_kec->result() as $row) { 
                                                    $sData = $this->model_security->countKec($row->kec);
                                                ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $row->kec; ?></td>
                                                    <td><?php echo number_format($sData['kec3'],0,'.','.'); ?></td> 
                                                    <td><?php echo $sData['kec2']; ?></td>
                                                    <td><?php echo $sData['kec1']; ?></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
