                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-border panel-primary">
                                    <div class="panel-heading"> 
                                        <h3 class="panel-title">Grafik TPS</h3> 
                                    </div> 
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <table id="datatable-responsive" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php $no=1;foreach ($data_tps->result() as $row) { 
                                                    $sData = $this->model_security->countTPS($row->tps);
                                                ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $row->tps; ?></td>
                                                    
                                                    <td><?php echo number_format($sData['tps3'],0,'.','.'); ?></td>
                                                    <td><?php echo $sData['tps2']; ?></td>
                                                    <td><?php echo $sData['tps1']; ?></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
