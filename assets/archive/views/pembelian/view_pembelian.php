                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    $tampiltotal = $this->db->query("SELECT DISTINCT
                                                            ...
                                                            FROM
                                                            detailkonfirmasipo
                                                            WHERE detailkonfirmasipo.fakturpo = '".$row->fakturpo."'");
                                                    foreach ($tampiltotal->result() as $srows) {
                                                    ?>
                                                    <td align="right"><?php echo number_format($srows->jmlditerima,0,'.','.'); ?></td>
                                                    <td align="right"><?php echo number_format($srows->total,0,'.','.'); ?></td>
                                                    <?php   } ?>
