                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="penjualanForm" name="penjualanForm" method="post" action="<?php echo base_url(); ?>penjualan/updatepenjualan">
                                                <div class="col-lg-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="select2 form-control" name="customer" id="customer">
                                                            <option value="<?php echo $customerid ?>" selected><?php echo $namacustomer; ?></option>
                                                            <?php $qCus=$this->db->query("select * from customer where customerid !='".$customerid."'");foreach ($qCus->result() as $row) { ?>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select class="form-control" id="metode" name="metode">
                                                            ...
                                                            <?php }elseif($metode == 3){ ?>
                                                                <option value="1">Tunai</option>
                                                                <option value="2">Transfer</option>
                                                                <option value="3" selected>Cek</option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input class="form-control" id="diskon" name="diskon" type="text" maxlength="2" value="<?php echo $diskon ?>" onkeypress="var charCode = (event.which) ? event.which : event.keyCode
