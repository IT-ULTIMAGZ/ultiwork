                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="petunjukForm" method="post" action="<?php echo base_url(); ?>petunjuk/getpetunjuk">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <textarea class="form-control" id="nama" name="nama" rows="5"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
