                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Form Edit Password Petugas (<?php echo $nama; ?>)</h3></div>
                                    <div class="panel-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="petugasEditPassword" method="post" action="<?php echo base_url(); ?>petugas/updatePasswordpetugas">
