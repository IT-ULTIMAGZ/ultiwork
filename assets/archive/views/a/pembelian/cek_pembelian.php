                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php foreach ($datacekpembelian->result() as $row) { ?>
                                                    ...
                                                    <td align="right"><?php if(!empty($row->jmlditerima)){ echo number_format($row->jmlditerima,0,'.','.'); } ?></td>
                                                    <td align="right"><?php if(!empty($row->total)){ echo number_format($row->total,0,'.','.'); } ?></td>
                                                    <td align="center"><?php if(!empty($row->bayar)){ if($row->bayar == 0){ echo "<b class='text-danger' title='Belum Dibayar'><i class='fa fa-close' title='Belum Dibayar'></i></b>";}else{echo "<b class='text-success' title='Sudah Dibayar'><i class='fa fa-check'></i></b>";} } ?></td>
                                                    <td align="center">
