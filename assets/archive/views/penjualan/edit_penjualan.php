                                        ...
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="penjualanForm" name="penjualanForm" method="post" action="<?php echo base_url(); ?>penjualan/updatepenjualan">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input class="form-control" id="diskon" name="diskon" type="text" maxlength="5" value="<?php echo $diskon ?>" onkeypress="var charCode = (event.which) ? event.which : event.keyCode
