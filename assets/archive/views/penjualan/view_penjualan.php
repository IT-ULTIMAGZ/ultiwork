                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    	...
                                                    	<?php /*<a href="<?php echo base_url() ?>penjualan/printpenjualan/<?php $id=$row->penjualanid; echo $this->encryption->encode($id); ?>" class="label label-primary" target="_BLANK" title="Cetak"><i class="fa fa-print"></i>&nbsp;</a> */ ?>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                                <?php } ?>
