...
<html>
    <head>
        ...
        <title>Login DinandaFrame</title>
        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"> Sign In to <strong>DinandaFrame</strong> </h3>
                </div> 
                ...
                <?php } ?>
                <form class="form-horizontal m-t-20" action="<?php echo base_url() ?>v1/getLogin" method="post" id="loginForm">
